...
function getFlickrSets(userid, target, numberToDisplay) {
    ...
    var url = "http://api.flickr.com/services/rest/?method=flickr.photosets.getList&api_key=51d1d9fb120a5eb100291180adb3d5b9&user_id=" + userid + "&format=json&jsoncallback=?";
    ...
    function displayImages(data) {
        ...
        var ctr = 0;
            ...
            var sourceMed = "http://farm" + theset.farm + ".static.flickr.com/" + theset.server + "/" + theset.primary + "_" + theset.secret + "_m.jpg";
            var setUrl = "http://www.flickr.com/photos/emmott/sets/" + theset.id;
